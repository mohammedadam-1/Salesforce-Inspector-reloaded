...
class Container:
    ...
    def _make_agent_service(self) -> AgentService:
        ...
        tool_registry.register(QueryMetadataTool(graph_service))
        tool_registry.register(AnalyzeDependenciesTool(graph_service))
        tool_registry.register(FindImpactTool(graph_service))
        tool_registry.register(GraphSummaryTool(graph_service))
